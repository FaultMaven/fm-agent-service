...
Copied from monolith: faultmaven/infrastructure/llm/providers/fireworks_provider.py
Implements Fireworks AI for high-performance inference with open-source models.
"""
...
class FireworksProvider(BaseLLMProvider):
    ...
    async def generate(
        ...
        **kwargs
        ...
        """Generate response using Fireworks AI (OpenAI-compatible API)"""
